# Generated by Django 3.1 on 2021-03-12 09:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_limit', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(21)], verbose_name='ограничение по возрасту')),
                ('rating', models.FloatField(blank=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='рейтинг пользователей')),
                ('imdb_rating', models.FloatField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='IMDB рейтинг')),
                ('movie_type', models.CharField(choices=[('movie', 'фильм'), ('serial', 'сериал'), ('tv_show', 'шоу'), ('cartoon', 'мультфильм')], max_length=20, verbose_name='тип')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='идентификатор')),
                ('role', models.CharField(choices=[('director', 'режиссер'), ('actor', 'актер'), ('writer', 'сценарист')], max_length=20, verbose_name='роль')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.AddConstraint(
            model_name='person',
            constraint=models.UniqueConstraint(fields=('firstname', 'lastname'), name='firstname_lastname_unique'),
        ),
        migrations.AddField(
